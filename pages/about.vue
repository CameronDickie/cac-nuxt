  ...
  <div class="mt-20" style="padding:10px;">
    ...
    <div class="w-screen h-screen flex justify-center items-center" >
      <div class="container mx-auto max-w-sm w-full p-4 sm:w-1/2">
        <div class="card flex flex-col justify-center p-10 bg-white rounded-lg shadow-2xl divide-y divide-gray-400">
          ...
          <p class="font-medium p-4">Founded in 2019, Climate Action Carleton is a student activist group based on the Carleton University campus that advocates for climate action and climate justice. We are an independent group run entirely by students.</p>
        </div>
      </div>
    </div>
  </div>
