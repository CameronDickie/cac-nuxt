<template>
  <div class="justify-center items-center mt-20">
    <div class="mx-auto flex flex-col justify-center text-center p-10 divide-y">
      <div class="p-4">
        <p class="text-4xl uppercase text-gray-900 font-bold">What is Climate Action Carleton?</p>
      </div>
      <div>
        <p
          class="font-medium p-4"
        >Founded in 2019, Climate Action Carleton is a student activist group based on the Carleton University campus that advocates for climate action and climate justice. We are an independent group run entirely by students.</p>
        <p
          class="font-medium p-4"
        >At Climate Action Carleton, we know that only clear, concrete, and transformative action is enough to tackle the global climate crisis. We understand that, because decades of incrementalism and stalling have delayed action and progress, we must act in an unprecedent, daring, and ambitious manner if we are going to have a shot at transforming our current situation.</p>
        <p
          class="font-medium p-4"
        >Both on and off the Carleton campus, Climate Action Carleton lobbies those who have the power to make impactful climate-related decisions that are essential for the future of Carleton’s students and the welfare of our community, country, and of our world.</p>
        <p
          class="font-medium p-4"
  ...
  <!-- <div class="mt-20" style="padding:10px;">
      ...
      <div class="container mx-auto w-full p-4 md:w-3/4 sm:w-1/2">
        ...
        >
          <div class="prod-title">
            <p class="text-2xl uppercase text-gray-900 font-bold">What is Climate Action Carleton?</p>
    ...
    <div class="w-screen flex pb-32 pt-32 justify-center items-center">
      <div class="container mx-auto w-full p-4 md:w-3/4 sm:w-1/2">
        ...
        >
          <div class="prod-title">
            <p class="text-2xl uppercase text-gray-900 font-bold">Our Mission</p>
            <p class="uppercase text-sm text-gray-400">what do we stand for?</p>
          </div>
          <p
            class="font-medium p-4"
          >To advocate, raise awareness, and take action upon issues of the global climate crisis within and beyond the Carleton community in a manner that recognizes the urgent need for unprecedented and transformative approaches to these problems, all while meaningfully incorporating an intersectional approach through considerations of indigeneity, race, and gender.</p>
